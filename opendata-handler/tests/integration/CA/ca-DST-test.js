...
const destinationInfo = {
    ...
    exist: true,
    destinationId: "d0c5ccde-a9fb-425a-9f5a-3699367794d4", //HPC02 airbyte ca_dst
    // "e57cf816-96d4-4bc5-bae8-0d4493e644ad", us_DST_destination 1K HPC01 airbyte
    name: "ca_DST_1K_destination"
}
        ...
        if (rSources == false) {
            ...
            while (i < count) {
                ...
                if (source != undefined) {
                    ...
                    if (checkResult == true) {
                        cnt++
                        console.log("CA DST: connection succeeded")
                    } else {
                        fcnt++
                        console.log("CA DST: connection failed")
                    }
                }
                i++
            }
